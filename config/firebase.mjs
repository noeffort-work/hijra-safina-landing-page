...
const firestorePortOverride = toPort(
  searchParams.get('firebaseFirestorePort'),
  8080,
)

const NORMALIZED_LOCALHOST = '127.0.0.1'
const defaultEmulatorHost = matchesLocalHostname
  ? hostname
  : NORMALIZED_LOCALHOST
const computedEmulatorHost =
  emulatorHostOverride || defaultEmulatorHost || NORMALIZED_LOCALHOST
